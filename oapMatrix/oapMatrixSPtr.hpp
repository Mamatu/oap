...
#include "oapSmartPointerUtils.hpp"
...
using ConstComplexMatrixDeleter = std::function<void(const oap::math::ComplexMatrix*)>;
using ConstComplexMatrixSharedPtr = MatrixSharedWrapper<const oap::math::ComplexMatrix, ConstComplexMatrixDeleter>;
using ConstComplexMatrixUniquePtr = MatrixUniqueWrapper<const oap::math::ComplexMatrix, ConstComplexMatrixDeleter>;

using ConstMatrixDeleter = std::function<void(const oap::math::Matrix*)>;
using ConstMatrixSharedPtr = MatrixSharedWrapper<const oap::math::Matrix, ConstMatrixDeleter>;
using ConstMatrixUniquePtr = MatrixUniqueWrapper<const oap::math::Matrix, ConstMatrixDeleter>;
