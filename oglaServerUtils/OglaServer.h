...
namespace core {
    ...
    private:
        Status registerFunction(utils::OglaFunction* function, std::vector<std::string>* names, void* ptr, uint& functionHandle);
        Status registerObject(utils::OglaObject* object, std::vector<std::string>* names, void* ptr, uint& objectHandle);
    ...
    public:
        ...
        Status executeFunction(LHandle connectionID, const char* functionName, utils::Writer& input, utils::ArgumentType* args, uint argc, utils::Reader& output);
        Status executeFunction(LHandle connectionID, const char** names, uint namesCount, utils::Writer& input, utils::ArgumentType* args, uint argc, utils::Reader& output);
        Status executeFunction(LHandle connectionID, LHandle functionHandle, utils::Writer& input, utils::ArgumentType* args, uint argc, utils::Reader& output);
    ...
    private:
        ...
        static void RegisterObject(utils::Reader& input, utils::Writer* output, void* ptr);
        static void UnregisterObject(utils::Reader& input, utils::Writer* output, void* ptr);
