...
ifeq ($(MODE), DebugSanitizer)
	...
	CXXOPTIONS := -c -g3 -DDEBUG -DSMS_TEST -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO) -fPIC
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS)
	NVCCOPTIONS := -g -G -DDEBUG -DSMS_TEST -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO)
...
ifeq ($(MODE), Debug)
	SANITIZER_LINKING :=
	SANITIZER_COMPILATION :=
	CXXOPTIONS := -c -g3 -DDEBUG -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO) -fPIC
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS)
	NVCCOPTIONS := -g -G -DDEBUG -DDOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS) $(USER_NVCCOPTIONS)
endif
...
ifeq ($(MODE), Release)
	SANITIZER_LINKING :=
	SANITIZER_COMPILATION :=
	CXXOPTIONS := -c -O2 -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO) -fPIC
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS)
	NVCCOPTIONS := -O2 -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) $(KERNEL_INFO)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS) $(USER_NVCCOPTIONS)
endif
