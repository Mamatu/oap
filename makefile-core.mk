...
LOG_LEVEL := DEBUG_LEVEL
	...
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS) -DLOG_LEVEL=$(LOG_LEVEL)
	NVCCOPTIONS := -g -G -DDEBUG -DSMS_TEST -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS) $(USER_NVCCOPTIONS) -DLOG_LEVEL=$(LOG_LEVEL)
endif
...
LOG_LEVEL := DEBUG_LEVEL
	...
	SANITIZER_LINKING :=
	SANITIZER_COMPILATION :=
	CXXOPTIONS += -c -g3 -DDEBUG -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) -fPIC -DOAP_ABORT_MEMLEAK
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS)  -DLOG_LEVEL=$(LOG_LEVEL)
...
LOG_LEVEL := INFO_LEVEL
	...
	SANITIZER_LINKING :=
	SANITIZER_COMPILATION :=
	CXXOPTIONS += -c -O2 -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES) -fPIC -DOAP_ABORT_MEMLEAK
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS) -DLOG_LEVEL=$(LOG_LEVEL)
