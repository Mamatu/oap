...
ifeq ($(MODE), DebugSanitizer)
	SANITIZER_LINKING := -fsanitize=address -fsanitize=leak -fno-omit-frame-pointer
	SANITIZER_COMPILATION := -fsanitize=address -fsanitize=leak -fno-omit-frame-pointer
...
ifeq ($(MODE), Debug)
	...
	CXXOPTIONS := -c -g3 -DOAP_PATH=$(OAP_PATH) -D$(TYPES) -D$(KERNEL_INFO) -fPIC
	CXXOPTIONS += $(EXTRA_CXXOPTIONS)
	NVCCOPTIONS := -g -G -DDOAP_PATH=$(OAP_PATH) -D$(TYPES) -D$(KERNEL_INFO)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS)
endif
