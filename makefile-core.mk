...
ifeq ($(MODE), DebugSanitizer)
	...
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS) -DLOG_LEVEL=DEBUG_LEVEL
	NVCCOPTIONS := -g -G -DDEBUG -DSMS_TEST -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS) $(USER_NVCCOPTIONS) -DLOG_LEVEL=DEBUG_LEVEL
endif
...
ifeq ($(MODE), Release)
	...
	CXXOPTIONS += $(EXTRA_CXXOPTIONS) $(USER_CXXOPTIONS) -DLOG_LEVEL=INFO_LEVEL
	NVCCOPTIONS := -O2 -DOAP_PATH=$(OAP_PATH) -DTMP_PATH=$(TMP_PATH) -D$(TYPES)
	NVCCOPTIONS += $(EXTRA_NVCCOPTIONS) $(USER_NVCCOPTIONS) -DLOG_LEVEL=INFO_LEVEL
endif
