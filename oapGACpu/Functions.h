...
class SetMutationType : public utils::OapFunction, public ParametersDeliver {
public:
    SetMutationType();
...
class BoundaryMutation : public utils::OapObject, public ParametersDeliver {

    class SetMutationsCount : public utils::OapFunction, public ParametersDeliver {
    public:
        uint steps;
        SetMutationsCount();
    protected:
    ...
    class SetRandomsRanges : public utils::OapFunction, public ParametersDeliver {
    public:
        floatt * bounds;
        uint count;
        SetRandomsRanges();
...
class SetCrossoverType : public utils::OapFunction, public ParametersDeliver {
...
class SetSelectionType : public utils::OapFunction, public ParametersDeliver {
    ga::GARatingExecutorCreatorCPU* gcc;
public:
    SetSelectionType();
protected:
...
class SetThreadsCount : public utils::OapFunction, public ParametersDeliver {
...
class SetSeed : public utils::OapFunction, public ParametersDeliver {
...
class SetRandomsFactor : public utils::OapFunction, public ParametersDeliver {
    ga::GAProcessConfiguratorCPU* ggc;
public:
    SetRandomsFactor();
protected:
