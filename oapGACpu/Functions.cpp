...
SetMutationType::SetMutationType() : utils::OapFunction("setMutationType", uintArgs, 1) {
}
...
BoundaryMutation::SetMutationsCount::SetMutationsCount() : utils::OapFunction("setMutationStep", uintArgs, 1), steps(1) {
}
...
BoundaryMutation::SetRandomsRanges::SetRandomsRanges() : utils::OapFunction("setRandomsRange", doublesArgs, 2), bounds(NULL), count(0) {
}
...
BoundaryMutation::BoundaryMutation() : utils::OapObject("boundaryMutation") {
...
SetCrossoverType::SetCrossoverType() : utils::OapFunction("setCrossoverType", uintArgs, 1), gcc(NULL) {
}
...
SetSelectionType::SetSelectionType() : utils::OapFunction("setSelectionType", uintArgs, 1), gcc(NULL) {
}
...
SetThreadsCount::SetThreadsCount() : utils::OapFunction("setThreadsCount", uintArgs, 1) {
}
...
SetSeed::SetSeed() : utils::OapFunction("setSeed", llArgs, 1) {
}
...
SetRandomsFactor::SetRandomsFactor() : utils::OapFunction("setRandomsFactor", uintArgs, 1) {
}
