...
namespace
{
  ...
  using GenericDeallocLayerApi = oap::alloc::DeallocLayerApi<decltype(oap::cuda::DeleteDeviceComplexMatrix), decltype(oap::chost::DeleteComplexMatrix)>;
}
...
class DeallocLayerApi : public GenericDeallocLayerApi
{
  public:
    DeallocLayerApi ():
    GenericDeallocLayerApi (oap::cuda::DeleteDeviceMatrix, oap::chost::DeleteMatrix)
    {}
};
