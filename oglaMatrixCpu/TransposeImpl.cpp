...
namespace math {
    namespace cpu {
        ...
        void TransposeOperation::Execute(void* ptr) {
            ThreadData<TransposeOperation>* threadData =
                    (ThreadData<TransposeOperation>*) ptr;
            floatt output = 0;
        ...
        void TransposeOperation::execute() {
            ...
            ThreadData<TransposeOperation>* threads =  m_threadData;
            for (uintt fa = 0; fa < threadsCount; fa++) {
                ...
                threads[fa].thread.setFunction(TransposeOperation::Execute, &threads[fa]);
