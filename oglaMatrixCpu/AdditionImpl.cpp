...
namespace math {
    namespace cpu {
        ...
        void AdditionOperation::execute() {
            ...
            ThreadData<AdditionOperation>* threads = m_threadData;
            ...
            for (uintt fa = 0; fa < threadsCount; fa++) {
                ...
                threads[fa].thread.setFunction(AdditionOperation::Execute, &threads[fa]);
        ...
        void AdditionOperation::Execute(void* ptr) {
            ThreadData<AdditionOperation>* threadData = (ThreadData<AdditionOperation>*) ptr;
