...
namespace math {
    namespace cpu {
        ...
        void DotProductOperation::execute() {
            ...
            ThreadData<DotProductOperation>* threads = m_threadData;
            for (uintt fa = 0; fa < threadsCount; fa++) {
                ...
                threads[fa].thread.setFunction(DotProductOperation::Execute, &threads[fa]);
        ...
        void DotProductOperation::Execute(void* ptr) {
            ThreadData<DotProductOperation>* threadData =
                    (ThreadData<DotProductOperation>*) ptr;
