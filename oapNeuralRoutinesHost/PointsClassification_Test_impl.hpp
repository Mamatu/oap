      ...
      CopyHostMatrixToKernelMatrix&& copyHostMatrixToKernelMatrix, GetMatrixInfo&& getMatrixInfo)
{
  ...
  {
    oap::HostComplexMatrixPtr hinput = oap::chost::NewReMatrix (1, coords.size() * 3);
  ...
  {
    oap::HostComplexMatrixPtr hexpected = oap::chost::NewReMatrix (1, coords.size());
...

  {
    ...
    oap::HostComplexMatrixPtr testHOutputs = oap::chost::NewReMatrix (1, testData.size());
    oap::HostComplexMatrixPtr trainingHOutputs = oap::chost::NewReMatrix (1, trainingData.size());
