...
std::vector<oap::HostComplexMatrixPtr> runForwardPropagation (const std::vector<uintt> ns, const std::vector<oap::HostComplexMatrixPtr> weights)
{
  ...
  std::vector<oap::HostComplexMatrixPtr> outputs;
