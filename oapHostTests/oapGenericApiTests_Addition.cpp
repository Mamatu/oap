...
TEST_F(OapGenericApiTests_Addition, Test_2)
{
  ...
  oap::HostComplexMatrixUPtr matrix11 = oap::chost::NewReMatrixFromMemory (1, 1, memory2, {0, 0});
  oap::HostComplexMatrixUPtr matrix12 = oap::chost::NewReMatrixFromMemory (1, 1, memory2, {1, 0});

  oap::HostComplexMatrixUPtr matrix21 = oap::chost::NewReMatrixFromMemory (1, 1, memory3, {0, 0});
  oap::HostComplexMatrixUPtr matrix22 = oap::chost::NewReMatrixFromMemory (1, 1, memory3, {1, 0});
...
TEST_F(OapGenericApiTests_Addition, Test_3)
{
  ...
  oap::HostComplexMatrixUPtr matrix11 = oap::chost::NewReMatrixWithValue (1, 1, 2.);
  oap::HostComplexMatrixUPtr matrix12 = oap::chost::NewReMatrixWithValue (1, 1, 1.);
...
TEST_F(OapGenericApiTests_Addition, Test_4)
{
  ...
  oap::HostComplexMatrixUPtr matrix21 = oap::chost::NewReMatrixFromMemory (1, 1, memory, {2, 0});
  oap::HostComplexMatrixUPtr matrix22 = oap::chost::NewReMatrixFromMemory (1, 1, memory, {3, 0});
...
TEST_F(OapGenericApiTests_Addition, Test_5)
{
  ...
  oap::HostComplexMatrixUPtr matrix11 = oap::chost::NewReMatrixWithValue (3, 3, 2.);
  oap::HostComplexMatrixUPtr matrix12 = oap::chost::NewReMatrixWithValue (3, 3, 1.);

  oap::HostComplexMatrixUPtr matrix21 = oap::chost::NewReMatrixWithValue (3, 3, 2.);
  oap::HostComplexMatrixUPtr matrix22 = oap::chost::NewReMatrixWithValue (3, 3, 1.);
...
TEST_F(OapGenericApiTests_Addition, Test_6)
{
  ...
  oap::HostComplexMatrixUPtr matrix11 = oap::chost::NewReMatrixWithValue (3, 3, 2.);
  oap::HostComplexMatrixUPtr matrix12 = oap::chost::NewReMatrixWithValue (2, 2, 1.);

  oap::HostComplexMatrixUPtr matrix21 = oap::chost::NewReMatrixFromMemory (3, 3, memory1, {0, 0});
  oap::HostComplexMatrixUPtr matrix22 = oap::chost::NewReMatrixFromMemory (2, 2, memory1, {4, 0});
