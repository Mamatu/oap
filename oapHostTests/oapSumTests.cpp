...
TEST_F(OapSumTests, SumTest1)
{
    uintt c = 1;
    uintt r = 1;
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
...
TEST_F(OapSumTests, SumTest4)
{
    uintt c = 10;
    uintt r = 1;
    test (c, r, [](int idx){ return idx; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
...
TEST_F(OapSumTests, SumTest7)
{
    uintt c = 10;
    uintt r = 11;
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue, 4);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
...
TEST_F(OapSumTests, SumTest8)
{
    uintt c = 204;
    uintt r = 104;
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue, 6*6);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
...
TEST_F(OapSumTests, SumTest10)
{
    uintt c = 13;
    uintt r = 13;
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue, 3*3);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
...
TEST_F(OapSumTests, SumTest11)
{
    uintt c = 13;
    uintt r = 13;
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(expected, reoutput); EXPECT_EQ(0, imoutput); }, oap::chost::NewReMatrixWithValue, 2*2);
    test (c, r, [](int idx){ return 1; }, [](int expected, int reoutput, int imoutput){ EXPECT_EQ(0, reoutput); EXPECT_EQ(expected, imoutput); }, oap::chost::NewImMatrixWithValue);
