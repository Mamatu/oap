...
TEST_F(oapGenericApiTests_HadamardProduct, Test5)
{
  ...
  math::ComplexMatrix* hostM1 = oap::host::NewReMatrixWithValue (3, 3, 2);
  math::ComplexMatrix* hostM2 = oap::host::NewReMatrixWithValue (3, 3, 3);

  math::ComplexMatrix* houtput = oap::host::NewReMatrix(3, 3);
