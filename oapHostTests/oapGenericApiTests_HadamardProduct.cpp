...
TEST_F(oapGenericApiTests_HadamardProduct, Test1)
{
  ...
  auto outputs = std::vector<math::Matrix*>({houtput});
  hostApi->v2_hadamardProduct (outputs, std::vector<math::Matrix*>({hostM1}), std::vector<math::Matrix*>({hostM2}));
...
TEST_F(oapGenericApiTests_HadamardProduct, Test5)
{
  ...
  math::Matrix* hostM1 = oap::host::NewReMatrixWithValue (3, 3, 2);
  math::Matrix* hostM2 = oap::host::NewReMatrixWithValue (3, 3, 3);

  math::Matrix* houtput = oap::host::NewReMatrix(3, 3);
