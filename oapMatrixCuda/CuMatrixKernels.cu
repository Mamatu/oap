...
extern "C" __global__ void
GenericApi_CUDAKernel_AddConstant (math::Matrix** outputs, math::Matrix* const* params1, floatt params2, uintt* mapper)
{
  GenericApi_CUDA_AddConstant (outputs, params1, params2, mapper);
}
