...
#include "CuDotProductDimProcedures.hpp"

#define PERIODIC_ROWS_IDX 3

__hostdevice__ void cuda_dotProductDimPeriodic (math::ComplexMatrix* output, math::ComplexMatrix* params0, math::ComplexMatrix* params1, uintt* ex)
{
  HOST_INIT();
  THREAD_INDICES_INIT();
