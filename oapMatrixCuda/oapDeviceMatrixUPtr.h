...
//inline DeviceMatricesUPtr makeDeviceMatricesUPtr(oap::math::Matrix** array, size_t count) {
//  return smartptr_utils::makeSmartUPtr<DeviceMatricesUPtr, oap::math::Matrix*>(array, count);
//}
