...
//inline DeviceComplexMatricesPtr makeDeviceComplexMatricesPtr(oap::math::ComplexMatrix** array, size_t count) {
//  return smartptr_utils::makeSmartPtr<DeviceComplexMatricesPtr, oap::math::ComplexMatrix*>(array, count);
//}
}
