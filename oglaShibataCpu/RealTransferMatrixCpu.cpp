...
RealTransferMatrix::RealTransferMatrix() : ::shibataCpu::cpu::TransferMatrix() {
...
void RealTransferMatrix::ExecuteTM(shibataCpu::cpu::Data* dataPtr, void* ptr) {
    debugFunc();
    RealTransferMatrix* rtm = (RealTransferMatrix*) ptr;
    math::Matrix* transferMatrix = dataPtr->transferMatrix;
    shibataCpu::Parameters* parameters = dataPtr->parameters;
