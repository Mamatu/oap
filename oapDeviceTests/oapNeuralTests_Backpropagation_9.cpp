...
#include "oapNeuralTests_Data_9.h"


class OapNeuralTests_Backpropagation_9 : public testing::Test
{
 public:
...
TEST_F(OapNeuralTests_Backpropagation_9, Test_1)
{
  using namespace oap::Backpropagation_Data_9;
