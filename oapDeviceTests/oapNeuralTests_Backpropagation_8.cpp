...
#include "oapNeuralTests_Data_8.h"

class OapNeuralTests_Backpropagation_8 : public testing::Test
{
 public:
...
TEST_F(OapNeuralTests_Backpropagation_8, Test_1)
{
  using namespace oap::Backpropagation_Data_8;
