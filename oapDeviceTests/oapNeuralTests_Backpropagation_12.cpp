...
#include "oapNeuralTests_Data_12.h"

class OapNeuralTests_Backpropagation_12 : public testing::Test
{
 public:
...
TEST_F(OapNeuralTests_Backpropagation_12, Test_1)
{
  using namespace oap::Backpropagation_Data_12;
