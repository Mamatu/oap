...
#include "oapNeuralTests_Data_5_2.h"

class OapNeuralTests_Backpropagation_5_2 : public testing::Test
{
 public:
...
TEST_F(OapNeuralTests_Backpropagation_5_2, Test_1)
{
  using namespace oap::Backpropagation_Data_5_Test_2;
