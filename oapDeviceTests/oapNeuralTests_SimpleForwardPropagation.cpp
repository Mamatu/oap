...
TEST_F(OapNeuralTests_SimpleForwardPropagation, SimpleForwardPropagation_1)
{
  ...
  oap::HostComplexMatrixPtr weights1to2 = oap::chost::NewReMatrix (2, 2);
  ...
  *GetRePtrIndex (weights1to2, 3) = 1;
  ...
  oap::HostComplexMatrixPtr weights2to3 = oap::chost::NewReMatrix (2, 1);
  ...
  *GetRePtrIndex (inputs, 1) = 1;
  ...
  oap::HostComplexMatrixPtr outputsL3 = oap::chost::NewReMatrix (minfo.columns(), minfo.rows());
...
TEST_F(OapNeuralTests_SimpleForwardPropagation, SimpleForwardPropagation_4)
{
  ...
  *GetRePtrIndex (inputs, 2) = 1;
  ...
  logInfo ("FP o2 %p %s", l2, oap::chost::to_string(outputsL2).c_str());
