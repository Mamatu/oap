...
#include "oapNeuralTests_Data_6.h"

class OapNeuralTests_Backpropagation_6 : public testing::Test
{
 public:
...
TEST_F(OapNeuralTests_Backpropagation_6, Test_1)
{
  using namespace oap::Backpropagation_Data_6;
