...
public class ColorChooser extends javax.swing.JFrame {
    ...
    protected PolarGrid polarGrid;

    /** Creates new form ColorChooser */
    public ColorChooser(PolarGrid polarGrid) {
        initComponents();
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        if (MODE == 0) {
            polarGrid.setGridColor(jColorChooser1.getColor());
        } else {
            polarGrid.setTextColor(jColorChooser1.getColor());
        }
        setVisible(false);
