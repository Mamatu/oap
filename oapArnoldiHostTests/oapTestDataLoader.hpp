...
class ACTestData
{
 ...
 public:
  ...
  ACTestData(const std::string& dir)
    ...
    refV = oap::chost::NewComplexMatrix(true, true, 1, m_elementsCount);
    refW = oap::chost::NewComplexMatrix(true, true, 1, m_elementsCount);
    hostV = oap::chost::NewComplexMatrix(true, true, 1, m_elementsCount);
    hostW = oap::chost::NewComplexMatrix(true, true, 1, m_elementsCount);
  }

  virtual ~ACTestData() {
    oap::chost::DeleteMatrix(refV);
    oap::chost::DeleteMatrix(refW);
    oap::chost::DeleteMatrix(hostV);
    oap::chost::DeleteMatrix(hostW);
  }
