...
class ConstHostComplexMatrixPtr : public ConstComplexMatrixSharedPtr
{
  public:
    ConstHostComplexMatrixPtr(ConstHostComplexMatrixPtr&& orig) = default;
    ConstHostComplexMatrixPtr(const ConstHostComplexMatrixPtr& orig) = default;
    ConstHostComplexMatrixPtr& operator=(ConstHostComplexMatrixPtr&& orig) = default;
    ConstHostComplexMatrixPtr& operator=(const ConstHostComplexMatrixPtr& orig) = default;

    ConstHostComplexMatrixPtr (const math::ComplexMatrix* matrix = nullptr, bool deallocate = true) :
      ConstComplexMatrixSharedPtr (matrix, [this](const math::ComplexMatrix* matrix) { host::DeleteMatrixWrapper (matrix, this); }, deallocate)
    {}

    virtual ~ConstHostComplexMatrixPtr () = default;

    operator const math::ComplexMatrix*() const {
      return this->get();
    }
};
