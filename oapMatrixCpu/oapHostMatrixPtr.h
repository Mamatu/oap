...
inline HostMatricesPtr makeHostMatricesPtr(oap::math::Matrix** array, size_t count) {
  return smartptr_utils::makeSmartPtr<HostMatricesPtr, oap::math::Matrix*>(array, count);
}
